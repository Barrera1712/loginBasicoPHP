	    ...
	    if ($contraseña === $confirmar_contraseña) {
	        ...
	        $hashContraseña = password_hash($contraseña, PASSWORD_BCRYPT);
	        	...
	        	try {
	        		...
	        		$query = "INSERT INTO usuario (nombre_usuario, contraseña,tipo_usuario) VALUES ('$usuario', '$hashContraseña','Normal')";
	        		//se ejecuta el query
...
<body>
	<form name="login" method="POST" action="">
		...
		<input type="text" name="usuario" placeholder="Ingresar su usuario" maxlength="50">
		<input type="password" name="password" placeholder="Ingresar su contraseña" maxlength="20">
		<input type="password" name="con-password" placeholder="Confirme su contraseña" maxlength="20">
